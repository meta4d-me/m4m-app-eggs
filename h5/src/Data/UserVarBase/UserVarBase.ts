...
export class UserVarBase extends ExcelDataBase{
	...
	*/
	...
	/**小人图标*/
	public littleManIcon:boolean;
	/**玩家角色*/
	public PlayerAccount:any;
	/**玩家角色Json*/
	public PlayerAccountJson:string;
	/**英雄列表*/
	public listOfFigures:{ [id: string]:any};
	/**英雄列表Json*/
	public listOfFiguresJson:string;
	/**布阵信息*/
...
public   clone(old:UserVarBase){
	...
	private static params = ["id","inGameStatus","currency","littleManIcon","PlayerAccount","listOfFigures","Arrangement","creatTime",];
