...
declare module "engine/game/particles/modules/particleEmitterShape" {
  ...
  export default class ParticleEmitterShape extends ParticleModule {
    ...
    static GetEmitterShapeData(dataBuffer: Float32Array, offsetMap: IParticleEmitterShapeOffsetMap, dst: Float32Array, speedOffset: number, positionOffset: number): void;
